<template id="qs-tsm-view-popup">
    <v-dialog v-model="dialog" :scrim="false" transition="dialog-bottom-transition" max-width="900px">
        <template v-slot:activator="{ props }">
            <v-card class="mx-auto" width="270px" elevation="1" outlined v-bind="props">
                <v-img :src="image_url" height="220px" cover :aspect-ratio="1"></v-img>
        ...
        <v-card>
            ...
            <v-row class="my-5 px-4">
                <v-col cols="12" md="4">
                    <v-img class="mx-auto" :src="image_url" width="250px" cover :aspect-ratio="1"></v-img>
                </v-col>
                <v-col cols="12" md="8">
